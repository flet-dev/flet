...
-   **macOS**
    ...
    ---
    <Image src="../assets/getting-started/counter-app/macos.png" alt="macOS" width="100%" />

-   **Windows**

    ---
    <Image src="../assets/getting-started/counter-app/windows.png" alt="windows" width="95%" />
...
<Image src="../assets/getting-started/counter-app/safari.png" alt="Web" width="70%" caption="Running Flet app as a web app" />
