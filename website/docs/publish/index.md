...
:::note[Using `requirements.txt` instead of `pyproject.toml`]
...
| ----- | --------------- | ------------- | -------- |
| 3.14  | 3.14.7          | 314.0.7       | default  |
| 3.13  | 3.13.15         | 0.29.5        | stable   |
| 3.12  | 3.12.14         | 0.27.8        | stable   |
