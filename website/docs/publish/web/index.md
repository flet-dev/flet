...
| **Python version**       | ⬇️ Tied to a specific Pyodide release — pick from the supported set (3.12 / 3.13 / 3.14). See [Bundled Python](../index.md#bundled-python).                                | ✅ Any Python version that runs your server.                                                                                |
