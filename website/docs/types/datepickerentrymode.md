---
class_name: "flet.DatePickerEntryMode"
examples: "../../examples/controls/types/date_picker_entry_mode"
...
<CodeExample path={frontMatter.examples + '/showcase.py'} language="python" />
