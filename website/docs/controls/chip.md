...
<CodeExample path={frontMatter.examples + '/assist_chips.py'} />

<Image src={frontMatter.example_media + '/assist_chips.png'} alt="assist-chips" width="80%" />
...
<CodeExample path={frontMatter.examples + '/filter_chips.py'} />

<Image src={frontMatter.example_media + '/filter_chips.png'} alt="filter-chips" width="80%" />
