...
<CodeExample path={frontMatter.examples + '/label_and_hint.py'} />

<Image src={frontMatter.example_media + '/label_and_hint.gif'} alt="label-and-hint" width="80%" />

### Handling events

<CodeExample path={frontMatter.examples + '/handling_events.py'} />

<Image src={frontMatter.example_media + '/handling_events.gif'} alt="handling-events" width="80%" />

### Add and delete options

<CodeExample path={frontMatter.examples + '/add_and_delete_options.py'} />

<Image src={frontMatter.example_media + '/add_and_delete_options.gif'} alt="add-and-delete-options" width="80%" />
