...
<CodeExample path={frontMatter.examples + '/animate_2.py'} />

### Animate 3

<CodeExample path={frontMatter.examples + '/animate_3.py'} />

### Animate 4

<CodeExample path={frontMatter.examples + '/animate_4.py'} />
