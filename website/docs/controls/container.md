...
<CodeExample path={frontMatter.examples + '/clickable.py'} language="python" />
...
<CodeExample path={frontMatter.examples + '/handling_hovers.py'} language="python" />

<Image src={frontMatter.example_media + '/handling_hovers.gif'} width="55%" />

### Animate 1

<CodeExample path={frontMatter.examples + '/animate_1.py'} language="python" />

<Image src={frontMatter.example_media + '/animate_1.gif'} width="55%" />

### Animate 2

<CodeExample path={frontMatter.examples + '/animate_2.py'} language="python" />

### Animate 3

<CodeExample path={frontMatter.examples + '/animate_3.py'} language="python" />

### Animate 4

<CodeExample path={frontMatter.examples + '/animate_4.py'} language="python" />

### Nested themes 1

<CodeExample path={frontMatter.examples + '/nested_themes_1.py'} language="python" />

<Image src={frontMatter.example_images + '/nested_themes_1.png'} width="55%" />

### Nested themes 2

<CodeExample path={frontMatter.examples + '/nested_themes_2.py'} language="python" />

<Image src={frontMatter.example_images + '/nested_themes_2.png'} width="55%" />

### Nested themes 3

<CodeExample path={frontMatter.examples + '/nested_themes_3.py'} language="python" />

<Image src={frontMatter.example_media + '/nested_themes_3.gif'} width="55%" />

### Size aware

<CodeExample path={frontMatter.examples + '/size_aware.py'} language="python" />
