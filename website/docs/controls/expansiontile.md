...
<ClassSummary name={frontMatter.class_name} image={frontMatter.example_images + '/image_for_docs.png'} imageCaption="ExpansionTile" />

## Examples

<CodeExample path={frontMatter.examples + '/expansion_tile/main.py'} language="python" />
