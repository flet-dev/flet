...
<CodeExample path={frontMatter.examples + '/keyboard_events.py'} />
...
<CodeExample path={frontMatter.examples + '/device_orientation.py'} />

### App exit confirmation

<CodeExample path={frontMatter.examples + '/app_exit_confirm_dialog.py'} />
...
<CodeExample path={frontMatter.examples + '/window_hidden_on_start.py'} />
...
<CodeExample path={frontMatter.examples + '/semantics_debugger.py'} />

### Get device locales

<CodeExample path={frontMatter.examples + '/device_locale.py'} />
