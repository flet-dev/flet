...
<Image src="../examples/tutorials/solitaire/media/part1-final.gif" alt="solitaire" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/drag-and-drop1.png" alt="drag_and_drop1" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/drag-and-drop2.gif" alt="drag_and_drop2" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/drag-and-drop4.gif" alt="drag_and_drop4.gif" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/drag-and-drop5.gif" alt="drag_and_drop5.gif" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/drag-and-drop6.gif" alt="drag_and_drop6.gif" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/fanned-piles3.gif" alt="fanned_piles1.gif" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/fanned-piles1.png" alt="fanned_piles1" width="80%" />

### Drag pile of cards

If you try to drag the card from the bottom of the pile now, it will look like this:

<Image src="../examples/tutorials/solitaire/media/fanned-piles2.gif" alt="drag_pile" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/game-setup-wiki.png" alt="game_setup_wiki" width="60%" />
...
<Image src="../examples/tutorials/solitaire/media/solitaire-layout.svg" alt="solitaire-layout" width="60%" />
...
<Image src="../examples/tutorials/solitaire/media/game-setup1.png" alt="game-setup1" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/game-setup2.png" alt="game-setup2" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/game-setup3.png" alt="game-setup3" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/game-rules2.gif" alt="game_rules2" width="80%" />
...
<Image src="../examples/tutorials/solitaire/media/winning-the-game.gif" alt="winning_the_game" width="80%" />
