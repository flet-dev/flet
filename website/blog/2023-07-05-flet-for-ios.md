...
**[Follow this guide](https://flet.dev/docs/getting-started/testing-on-mobile/)** to get started with testing your Flet apps on iPhone or iPad. Explore the app, browse gallery, play with sample projects and app settings.
