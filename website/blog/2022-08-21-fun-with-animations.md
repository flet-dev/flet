...
`Page` now contains [`on_keyboard_event`](https://flet.dev/docs/controls/page/#flet.Page.on_keyboard_event) event handlet to globally intercept all keystrokes.
...
A control that applies a mask generated by a shader to its content. Allows making nice effects like [gradually fading out images](https://flet.dev/docs/controls/shadermask/#fade-out-bottom-edge-of-an-image).
