...
- The new [documentation website](https://flet.dev/docs/) based on mkdocs, generated from Flet code base and always up-to-date.
...
- [flet debug](https://flet.dev/docs/cli/flet-debug/) CLI for debugging app on real [devices](https://flet.dev/docs/cli/flet-devices/) and [emulators](https://flet.dev/docs/cli/flet-emulators/).
...
[Read more about testing on iOS and Android](https://flet.dev/docs/getting-started/testing-on-mobile/).
