...
* Fix `TooltipTheme.decoration` not applying to controls using `ft.Tooltip(...)` unless the tooltip also defined a local decoration ([#6432](https://github.com/flet-dev/flet/issues/6432)) by @ndonkoHenri.
