...
* Improve performance of checking added/removed controls in Session.patch_control from O(N²) to O(N) ([#6650](https://github.com/flet-dev/flet/pull/6650)) by @davidlawson.
