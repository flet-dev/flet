...
* `Dropdown.expand` has no effect ([#5042](https://github.com/flet-dev/flet/pull/5042))
...
* `LineChartDataPoint.tooltip` not properly rendered ([#5105](https://github.com/flet-dev/flet/pull/5105))
* broken code in `Page.__on_authorize_async` ([#5154](https://github.com/flet-dev/flet/pull/5154))
