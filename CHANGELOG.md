...
* Fix child components losing click events when passed as control arguments to a component that re-renders ([#6857](https://github.com/flet-dev/flet/issues/6857)) by @FeodorFitsner.
