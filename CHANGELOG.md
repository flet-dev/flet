...
* Add the `flet-webview-all` extension with a `FletWebviewAll` control providing cross-platform webview support on Windows, macOS, Linux, iOS, Android, and Web via the [`webview_all`](https://pub.dev/packages/webview_all) Flutter package ([#6530](https://github.com/flet-dev/flet/issues/6530)).
