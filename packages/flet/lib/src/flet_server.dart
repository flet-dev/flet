  ...
  registerWebClientInternal() {
    ...
    send(Message(
        ...
        payload: RegisterWebClientRequest(
            ...
            pageWidth: page?.getString("pageWidth") ?? _pageWidth,
            pageHeight: page?.getString("pageHeight") ?? _pageHeight,
            windowLeft: page?.getString("windowLeft") ?? _windowLeft,
            windowTop: page?.getString("windowTop") ?? _windowTop,
            windowWidth: page?.getString("windowWidth") ?? _windowWidth,
            windowHeight: page?.getString("windowHeight") ?? _windowHeight,
            isPWA: _isPWA,
            isWeb: _isWeb,
            isDebug: _isDebug,
            platform: _platform,
