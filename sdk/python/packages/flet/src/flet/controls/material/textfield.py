...
class TextField(FormFieldControl, AdaptiveControl):
    ...
    on_change: ControlEventHandler["TextField"] = None
    """
    Fires when the typed input for the TextField has changed.
    """

    on_click: ControlEventHandler["TextField"] = None
    """
    TBD
    """

    on_submit: ControlEventHandler["TextField"] = None
    """
    Fires when user presses ENTER while focus is on TextField.
    """

    on_focus: ControlEventHandler["TextField"] = None
    """
    Fires when the control has received focus.
    """

    on_blur: ControlEventHandler["TextField"] = None
    """
    Fires when the control has lost focus.
    """

    on_tap_outside: ControlEventHandler["TextField"] = None
    """
    TBD
    """
