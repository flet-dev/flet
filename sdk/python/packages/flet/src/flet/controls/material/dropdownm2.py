...
class Option(Control):
    ...
    on_click: ControlEventHandler["Option"] = None
    """
...
class DropdownM2(FormFieldControl):
    ...
    on_change: ControlEventHandler["DropdownM2"] = None
    """
    Fires when the selected item of this dropdown has changed.
    """

    on_focus: ControlEventHandler["DropdownM2"] = None
    """
    Fires when the control has received focus.
    """

    on_blur: ControlEventHandler["DropdownM2"] = None
    """
    Fires when the control has lost focus.
    """

    on_click: ControlEventHandler["DropdownM2"] = None
    """
