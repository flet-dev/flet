...
class ExpansionTile(ConstrainedControl, AdaptiveControl):
    ...
    Padding value is an instance of [`Padding`](https://flet.dev/docs/reference/types/padding) class.
    """
    ...
    Value is of type [`TileAffinity`](https://flet.dev/docs/reference/types/tileaffinity) and defaults to `TileAffinity.PLATFORM`.
    """
    ...
    Value is of type [`CrossAxisAlignment`](https://flet.dev/docs/reference/types/crossaxisalignment) and defaults
    ...
    """
    The [color](https://flet.dev/docs/reference/colors) of the tile's titles when the sublist is expanded.
    """

    icon_color: OptionalColorValue = None
    """
    The icon [color](https://flet.dev/docs/reference/colors) of tile's expansion arrow icon when the sublist is expanded.
    """
    ...
    """
    The  [color](https://flet.dev/docs/reference/colors) to display behind the sublist when expanded.
    """

    collapsed_bgcolor: OptionalColorValue = None
    """
    Defines the background [color](https://flet.dev/docs/reference/colors) of tile when the sublist is collapsed.
    """

    collapsed_icon_color: OptionalColorValue = None
    """
    The icon [color](https://flet.dev/docs/reference/colors) of tile's expansion arrow icon when the sublist is collapsed.
    """

    collapsed_text_color: OptionalColorValue = None
    """
    The [color](https://flet.dev/docs/reference/colors) of the tile's titles when the sublist is collapsed.
    """
