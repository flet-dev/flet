...
async def test_image_for_docs(flet_app_function: ftt.FletTestApp, request):
    ...
    flet_app_function.page.show_dialog(
        ft.DatePicker(
            value=datetime.datetime(2025, 4, 15),
...
async def test_basic(flet_app_function: ftt.FletTestApp):
    ...
    await flet_app_function.tester.tap(
        await flet_app_function.tester.find_by_text("Pick date")
    )
    await flet_app_function.tester.pump_and_settle()
...
async def test_custom_locale(flet_app_function: ftt.FletTestApp):
    ...
    await flet_app_function.tester.tap(
        await flet_app_function.tester.find_by_text("Pick date (zh_Hans locale)")
    )
    await flet_app_function.tester.pump_and_settle()
