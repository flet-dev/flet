This article explains how to control the level of log messages generated by Flet
library and its underlying components.
You may need to enable detailed logging to troubleshoot Flet or when submitting
a new Flet issue.
