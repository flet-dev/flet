...
```python
--8<-- "https://raw.githubusercontent.com/flet-dev/flet/refs/heads/docs/fix-links/sdk/python/examples/controls/constrained-control/animate-opacity.py"
```

![animate-opacity](https://raw.githubusercontent.com/flet-dev/flet/docs/fix-links/sdk/python/examples/controls/constrained-control/media/animate-opacity.gif){width="80%"}
/// caption
///
...
```python
--8<-- "https://raw.githubusercontent.com/flet-dev/flet/refs/heads/docs/fix-links/sdk/python/examples/controls/constrained-control/animate-rotation.py"
```

![animate-rotation](https://raw.githubusercontent.com/flet-dev/flet/docs/fix-links/sdk/python/examples/controls/constrained-control/media/animate-rotation.gif){width="80%"}
/// caption
///
...
```python
--8<-- "https://raw.githubusercontent.com/flet-dev/flet/refs/heads/docs/fix-links/sdk/python/examples/controls/constrained-control/animate-scale.py"
```

![animate-scale](https://raw.githubusercontent.com/flet-dev/flet/docs/fix-links/sdk/python/examples/controls/constrained-control/media/animate-scale.gif){width="80%"}
/// caption
///
...
```python
--8<-- "https://raw.githubusercontent.com/flet-dev/flet/refs/heads/docs/fix-links/sdk/python/examples/controls/constrained-control/animate-offset.py"
```

![animate-offset](https://raw.githubusercontent.com/flet-dev/flet/docs/fix-links/sdk/python/examples/controls/constrained-control/media/animate-offset.gif){width="80%"}
/// caption
///
...
```python
--8<-- "https://raw.githubusercontent.com/flet-dev/flet/refs/heads/docs/fix-links/sdk/python/examples/controls/constrained-control/animate-position.py"
```

![animate-position](https://raw.githubusercontent.com/flet-dev/flet/docs/fix-links/sdk/python/examples/controls/constrained-control/media/animate-position.gif){width="80%"}
/// caption
///
...
```python
--8<-- "https://raw.githubusercontent.com/flet-dev/flet/refs/heads/docs/fix-links/sdk/python/examples/controls/container/animate.py"
```

![animate](https://raw.githubusercontent.com/flet-dev/flet/docs/fix-links/sdk/python/examples/controls/container/media/animate-1.gif){width="80%"}
/// caption
///
