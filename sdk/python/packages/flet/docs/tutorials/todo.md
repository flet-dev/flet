...
{{ image("../examples/tutorials/todo/media/hello-world.png", width="80%") }}
...
{{ image("../examples/tutorials/todo/media/app-1.png", width="80%") }}
...
{{ image("../examples/tutorials/todo/media/diagram-1.svg", width="80%") }}
...
{{ image("../examples/tutorials/todo/media/app-2.png", width="80%") }}
...
{{ image("../examples/tutorials/todo/media/diagram-2.svg", width="80%") }}
...
{{ image("../examples/tutorials/todo/media/view-edit-delete.gif", width="80%") }}
