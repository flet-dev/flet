...
example_test_images: ../test-images/examples/material/golden/macos/container
---
...
{{ image(example_test_images + "/nested_themes_1.png", width="80%") }}
...
{{ image(example_test_images + "/nested_themes_2.png", width="80%") }}
...
{{ image(example_test_images + "/size_aware.png", width="80%") }}
