...
This command is used to publish a Flet application as a standalone static web app using Pyodide.
You can find it's guide [here](../publish/web/static-website/index.md).
