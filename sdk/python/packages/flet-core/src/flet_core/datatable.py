...
class DataCell(Control):
    def __init__(
        ...
        on_tap_cancel: OptionalEventCallback = None,
    ...
    # on_tap_cancel
    @property
    def on_tap_cancel(self) -> OptionalEventCallback:
        return self._get_event_handler("tap_cancel")

    @on_tap_cancel.setter
    def on_tap_cancel(self, handler: OptionalEventCallback):
...
class DataRow(Control):
    def __init__(
        ...
        on_long_press: OptionalEventCallback = None,
        on_select_changed: OptionalEventCallback = None,
        #
        # Control
        #
        ref=None,
    ...
    # on_select_changed
    @property
    def on_select_changed(self) -> OptionalEventCallback:
        return self._get_event_handler("select_changed")

    @on_select_changed.setter
    def on_select_changed(self, handler: OptionalEventCallback):
...
class DataTable(ConstrainedControl):
    def __init__(
        ...
        on_select_all: OptionalEventCallback = None,
        #
        # ConstrainedControl
        #
    ...
    # on_select_all
    @property
    def on_select_all(self) -> OptionalEventCallback:
        return self._get_event_handler("select_all")

    @on_select_all.setter
    def on_select_all(self, handler: OptionalEventCallback):
