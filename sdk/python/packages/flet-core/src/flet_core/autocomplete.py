...
class Autocomplete(FormFieldControl):
    """
    A autocomplete lets the user select from a number of items. The autocomplete shows the currently selected item as well as an arrow that opens a menu for selecting another item.
    ...
    def main(page: ft.Page):
        def button_clicked(e):
            t.value = f"Autocomplete value is:  {dd.value}"
            page.update()
