...
flet publish python/apps/routing-navigation/home-store.py --distpath $DIST_PATH/simple-routing --base-url simple-routing --route-url-strategy "hash" --app-name "Flet routing example" --app-description "An example of routing in Flet."
